...
class MyTestCase(unittest.TestCase):
    ...
    def test_square_method_calculator(self):
        test_data = CSVReader('/UnitTests/TestData/Square.csv').data
        for row in test_data:
